...
def upgrade() -> None:
    ...
    # Backfill dataset records from existing files
    # Set total_files to 0 initially - will be updated when queries are refreshed
    op.execute("""
        INSERT INTO dataset (dataset_id, total_files, created_at, updated_at)
        SELECT DISTINCT dataset_id, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
        FROM file
