...
def handle_file_complete_high(file, destination, logger):
...
def handle_file_complete_normal(file, destination, logger):
...
def handle_file_complete_low(file, destination, logger):
